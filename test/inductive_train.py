...
parser.add_argument('--pkl_name', type=str, default='inductive_dsn_fold77.pkl')
...
fold = 1
###### Dataset
df_ddi_train = pd.read_csv(f'../dataset/inductive_data/fold' + str(fold) + '/train.csv')
df_ddi_s1 = pd.read_csv(f'../dataset/inductive_data/fold' + str(fold) + '/s1.csv')
df_ddi_s2 = pd.read_csv(f'../dataset/inductive_data/fold' + str(fold) + '/s2.csv')
...
model = BDN_DDI(n_atom_feats, n_atom_hid, kge_dim, rel_total, heads_out_feat_params=[64, 64, 64, 64, 64, 64],
