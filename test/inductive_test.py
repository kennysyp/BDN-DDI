...
TPR_list, FPR_list, AUROC_list = [], [], []
names = ['slice1', 'slices2', 'slices4', 'slices8']
######################### Parameters ######################
...
s1_data = DrugDataset(s1_tup, disjoint_split=False)
s2_data = DrugDataset(s2_tup, disjoint_split=False)
