...
df_ddi_train = pd.read_csv('../dataset/drugbank/fold1/train.csv')
df_ddi_test = pd.read_csv('../dataset/drugbank/fold1/test.csv')
...
model = BDN_DDI(n_atom_feats, n_atom_hid, kge_dim, rel_total, heads_out_feat_params=[64,64,64,64,64,64], blocks_params=[2, 2, 2, 2,2,2])
